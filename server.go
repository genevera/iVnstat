...
var staticPath = fmt.Sprintf("%s/src/github.com/sarim/iVnstat/static", os.Getenv("GOPATH"))
...
func setStaticDir(ctx *web.Context) bool {
	ctx.Server.Config.StaticDir = staticPath
	return true
}

func main() {
	fmt.Sprintf("%v",setStaticDir)
